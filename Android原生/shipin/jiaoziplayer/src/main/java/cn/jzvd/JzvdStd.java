...
public class JzvdStd extends Jzvd {
    ...
    public void init(Context context) {
        super.init(context);
        rotateButton = (ImageView) findViewById(R.id.iv_rotate);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
           ...
           boolean isTrue= backPress();
           if(!isTrue&&jzInterface!=null){
               jzInterface.clickBackPress();
           }
...
//            };
            ...
            int rotate=0;
            try{
                rotate=(int)CURRENT_JZVD.textureView.getRotation();
            }catch (Exception e){
            ...
            Jzvd.setTextureViewRotation(rotate);
        }
    }
    ...
    public void setScreenNormal() {
        ...
        if(jzInterface!=null&&jzInterface.isShowBack()){
...
//            });
    ...
    public void clickThumb(){
        if(jzInterface!=null&&!jzInterface.clickThumbPre()){
    ...
    /*----------------------------*/
    protected JzInterface jzInterface;

    public void setJzInterface(JzInterface jzInterface){
        this.jzInterface=jzInterface;
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if(jzInterface!=null){
            jzInterface.onProgressChanged(seekBar,progress,fromUser);
        }
    }
