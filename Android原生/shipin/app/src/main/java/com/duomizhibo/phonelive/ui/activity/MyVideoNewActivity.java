...
public class MyVideoNewActivity extends ToolBarBaseActivity implements RefreshLayout.OnRefreshListener {
    ...
    protected int getLayoutId() {
        return R.layout.new_activity_my_video;
    }
    ...
    public void initView() {
        ...
        ll_shangchuan.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.ll_shangchuan:
                UIHelper.showVideoUploadActivity(this);
                break;
        }
    ...
    public void onRefresh() {
        page=1;
        PhoneLiveApi.myVideoList(page,10,AppContext.getInstance().getToken(),mLoadMoreCallback);
