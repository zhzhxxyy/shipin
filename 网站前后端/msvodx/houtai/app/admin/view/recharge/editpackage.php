<div class="layui-tab-item layui-show">
    <form class="layui-form layui-form-pane" action="{:url('')}" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="checkbox" name="permanent"  {if condition="$info['permanent'] eq 1"}checked="checked"{/if}  lay-skin="switch" lay-text="是|否" lay-filter='permanent' >
            </div>
            <div class="layui-form-mid layui-word-aux"></div>
        </div>
        ...
        <div class="layui-form-item" id="days" style="display: block">
            ...
            <div class="layui-input-inline">
                <input type="text"  class="layui-input" name="days" value="{:$info['days']}" autocomplete="off" placeholder="请填写套餐天数">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  class="layui-input" name="sort"  value="{:$info['sort']}" autocomplete="off" placeholder="请填写排序值">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <textarea rows="6" class="layui-textarea" name="info" autocomplete="off" placeholder="请填写描述">{:$info['info']}</textarea>
            </div>
            <div class="layui-form-mid layui-word-aux"></div>
        </div>
