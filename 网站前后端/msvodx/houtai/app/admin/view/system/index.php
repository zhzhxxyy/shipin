<div class="layui-tab-item layui-show">
    <form class="layui-form layui-form-pane" action="{:url('')}" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="buy_cardpassword_uri" value="{$config['buy_cardpassword_uri']}" autocomplete="off" placeholder="输入客服地址">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="lianxi_qq" value="{$config['lianxi_qq']}" autocomplete="off" placeholder="输入客服QQ">
            </div>
