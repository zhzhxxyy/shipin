...
<div class="layui-tab-item layui-show layui-form-pane">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="name" lay-verify="required" autocomplete="off" value="{$tag['name']}" placeholder="请输入标签">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">排&nbsp;&nbsp;&nbsp;&nbsp;序</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-nick" name="sort" lay-verify="required"  autocomplete="off" value="{$tag['sort']}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="radio" class="field-status" name="status" value="1" title="启用" {if condition="$tag['status'] eq 1"} checked {/if}>
            <input type="radio" class="field-status" name="status" value="0" title="禁用" {if condition="$tag['status'] eq 0"} checked {/if}>
        </div>
    </div>
</div>
