    ...
    <form class="layui-form layui-form-pane" action="{:url('')}" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="name" value="{$info['name']}" autocomplete="off" placeholder="请填写名称">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <textarea rows="6"  class="layui-textarea" name="intro" autocomplete="off" placeholder="请填写说明">{$info['intro']}</textarea>
            </div>
        </div>
