...
<form action="#" class="page-list-form layui-form layui-form-pane" method="post">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="app_name" class="layui-input" name="video[app_name]" value="{$info['app_name']}" autocomplete="off" placeholder="请填写">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="app_domain" class="layui-input" name="video[app_domain]" value="{$info['app_domain']}" autocomplete="off" placeholder="请填写">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input" name="video[app_icon]" id="app_icon"  value="{$info['app_icon']}" autocomplete="off"  placeholder="APP图标">
        </div>
        <div class="layui-input-inline">
            <a id="icon_up_btn" href="javascript:" class="layui-btn layui-btn-primary" style="background-color: #fff;">上传</a>
            &nbsp;&nbsp; <img onmouseout="layer.closeAll();"  onmouseover="imgTips(this,{width:320})" style="border-radius:5px;border:1px solid #ccc;"  height="36" id="app_icon_thumb" src="{$info['app_icon']}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="app_bid_ios" class="layui-input" name="video[app_bid_ios]" value="{$info['app_bid_ios']}" autocomplete="off" placeholder="请填写IOS bundle">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="app_bsvs_ios" class="layui-input" name="video[app_bsvs_ios]" value="{$info['app_bsvs_ios']}" autocomplete="off" placeholder="请填写IOS版本号">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input" name="video[app_plist_ios]"  id="app_plist_ios" value="{$info['app_plist_ios']}" autocomplete="off"  placeholder="IOS文件路径">
        </div>
        <div class="layui-input-inline">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="app_bid_android" class="layui-input" name="video[app_bid_android]" value="{$info['app_bid_android']}" autocomplete="off" placeholder="请填写Android bundle">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="app_bsvs_android" class="layui-input" name="video[app_bsvs_android]" value="{$info['app_bsvs_android']}" autocomplete="off" placeholder="请填写Android版本号">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input" name="video[app_plist_android]"  id="app_plist_android" value="{$info['app_plist_android']}" autocomplete="off"  placeholder="Android文件路径">
        </div>
        <div class="layui-input-inline">
