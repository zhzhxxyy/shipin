{if condition="input('param.hisi_iframe') || cookie('hisi_iframe') || $tab_type==='no_menu'"}
<!DOCTYPE html>
<html>
<head>
    <title>{$_admin_menu_current['title']} -  Powered by baidu版</title>
...
<html>
<head>
    <title>{if condition="$_admin_menu_current['url'] eq 'admin/index/index'"}管理控制台{else /}{$_admin_menu_current['title']}{/if} -   Powered by baidu版</title>
    <meta http-equiv="Access-Control-Allow-Origin" content="*">
    <link rel="stylesheet" href="__ADMIN_JS__/layui/css/layui.css">
    <link rel="stylesheet" href="__ADMIN_CSS__/style.css">
    <link rel="stylesheet" href="__STATIC__/fonts/typicons/min.css">
...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header" style="z-index:999!important;">
        ...
        <ul class="layui-nav fr nobg head-info">
            <li class="layui-nav-item">
                <a href="javascript:void(0);">{$admin_user['version']}&nbsp;&nbsp;</a>
