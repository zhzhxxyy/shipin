...
<form id="pageListForm" class="layui-form layui-form-pane" method="get">
    <div class="layui-btn-group">
        ...
        <a data-href="{:url('status?table=novel&val=1')}" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-qiyong"></i>启用</a>
        <a data-href="{:url('status?table=novel&val=0')}" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-jinyong1"></i>禁用</a>
    ...
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td>{$vo['gold']}</td>
                <td>
                    <input type="checkbox"  {if condition="$vo['status'] eq 1"}checked=""{/if} value="{$vo['status']}" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="{:url('status?table=novel&ids='.$vo['id'])}">
                </td>
                ...
                <td>
                    <div class="layui-btn-group">
                        ...
                        <a href="{:url('del?table=novel&ids='.$vo['id'])}" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                    </div>
                </td>
            </tr>
            {/volist}
