...
class Uploader
{
    ...
    public function getUploadConfig()
    {
        ...
        $ipaConf=['ipa_save_server_type'=>'web_server','config'=>['web_server_url'=>$config['web_server_url']]];
        $apkConf=['apk_save_server_type'=>'web_server','config'=>['web_server_url'=>$config['web_server_url']]];
