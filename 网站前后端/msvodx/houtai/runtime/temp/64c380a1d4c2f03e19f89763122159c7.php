    ...
    <form class="layui-form layui-form-pane" action="<?php echo url(''); ?>" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  class="layui-input" name="sms_api_account" value="<?php echo $config['sms_api_account']; ?>" autocomplete="off" placeholder="短信api账号">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  class="layui-input" name="sms_api_password" value="<?php echo $config['sms_api_password']; ?>" autocomplete="off" placeholder="短信api密码">
            </div>
            <div class="layui-form-mid layui-word-aux" >短信api账号</div>
        </div>
