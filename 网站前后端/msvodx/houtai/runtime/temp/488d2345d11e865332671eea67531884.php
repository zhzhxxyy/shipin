    ...
    <form class="layui-form layui-form-pane" action="<?php echo url(''); ?>" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="checkbox" name="look_at_on"  lay-skin="switch" lay-text="支持|关闭" <?php if($config['look_at_on'] == 1): ?>checked=""<?php endif; ?>>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="look_at_measurement" class="field-role_id" type="select"  name="look_at_measurement"  lay-skin="switch" lay-filter="look_at_measurement"  >
                    <option value="1" <?php if($config['look_at_measurement'] == 1): ?>selected=""<?php endif; ?>>部</option>
                    <option value="2" <?php if($config['look_at_measurement'] == 2): ?>selected=""<?php endif; ?>>秒</option>
                </select>
            </div>
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label" id="look_at_num"><b>PC</b>试看<?php if($config['look_at_measurement'] == 1): ?>部<?php else: ?>秒<?php endif; ?>数</label>
            <div class="layui-input-inline">
                <input type="number"  class="layui-input" name="look_at_num" value="<?php echo $config['look_at_num']; ?>" autocomplete="off" placeholder="请填写可试看数量">
            </div>
            <div class="layui-form-mid layui-word-aux" id="look_at_tpis" ><?php if($config['look_at_measurement'] == 1): ?>可试看的部数，如可试看1部，则填写1<?php else: ?>每部可试看多少秒，如可试看30秒，则填写30<?php endif; ?></div>
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label" id="look_at_num"><b>手机</b>试看部数</label>
            <div class="layui-input-inline">
                <input type="number"  class="layui-input" name="look_at_num_mobile" value="<?php echo $config['look_at_num_mobile']; ?>" autocomplete="off" placeholder="请填写可试看数量">
            </div>
