    ...
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td class="font12">
                    <p class="ml10 fl"><strong class="mcolor"><?php echo $title; ?>：<?php echo $vo['title']; ?> </strong><br>分类：<?php echo $vo['name']; ?><br></p>
                </td>
                <td class="font12"><?php echo date('Y-m-d H:i:s', $vo['view_time']); ?></td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
        </table>
