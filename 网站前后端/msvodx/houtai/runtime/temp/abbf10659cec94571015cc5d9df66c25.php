...
<form class="page-list-form">
    <div class="page-toolbar">
        <div class="layui-btn-group fl">
            <a href="<?php echo url('classadd',['type'=>$type]); ?>" class="layui-btn layui-btn-primary"><i class="aicon ai-tianjia"></i>添加</a>
            <a data-href="<?php echo url('khstatus?table=class&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-qiyong"></i>启用</a>
            <a data-href="<?php echo url('khstatus?table=class&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-jinyong1"></i>禁用</a>
            <!--<a data-href="<?php echo url('khdel?table=class'); ?>" class="layui-btn layui-btn-primary j-page-btns confir m"><i class="aicon ai-jinyong"></i>删除</a>-->
    ...
    <?php if(is_array($classlist) || $classlist instanceof \think\Collection || $classlist instanceof \think\Paginator): $kk = 0; $__LIST__ = $classlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($kk % 2 );++$kk;?>
    <dl class="menu-dl1">
        <dt>
            <input type="checkbox" name="ids[<?php echo $kk; ?>]" value="<?php echo $vv['id']; ?>" class="checkbox-ids" lay-skin="primary" title="<?php echo $vv['name']; ?>">
            <input type="text" class="menu-sort j-ajax-input" name="sort[<?php echo $kk; ?>]" onkeyup="value=value.replace(/[^\d]/g,'')" value="<?php echo $vv['sort']; ?>" data-value="<?php echo $vv['sort']; ?>" data-href="<?php echo url('khsort?table=class&ids='.$vv['id']); ?>">
            <input type="checkbox" name="status" value="<?php echo $vv['status']; ?>" <?php if($vv['status'] == 1): ?>checked=""<?php endif; ?> lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('khstatus?table=class&ids='.$vv['id']); ?>">
           <?php if(empty($vv['childs'])): ?>
            <div class="menu-btns" style=" left: 198px;">
                <input type="checkbox" name="status" value="<?php echo $vv['home_dispay']; ?>" <?php if($vv['home_dispay'] == 1): ?>checked=""<?php endif; ?> lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('khstatus?table=class&field=home_dispay&ids='.$vv['id']); ?>">
            </div>
            <?php endif; ?>
            <div class="menu-bt">
                <a href="<?php echo url('classedit',['id'=>$vv['id'],'type'=>$type]); ?>" title="编辑"><i class="layui-icon">&#xe642;</i></a>
                <a href="<?php echo url('classadd',['id'=>$vv['id'],'type'=>$type]); ?>" title="添加子菜单"><i class="layui-icon">&#xe654;</i></a>
                <?php if($vv['type'] == 1): ?>
                <a href="<?php echo url('video/deleteClass',['table'=>'class','id'=>$vv['id']]); ?>"  class="layui-btn layui-btn-primary layui-btn-small"><i class="layui-icon">&#xe640;</i>删除</a>
                <?php elseif($vv['type'] == 2): ?>
                <a href="<?php echo url('image/deleteClass',['table'=>'class','id'=>$vv['id']]); ?>" class="layui-btn layui-btn-primary layui-btn-small"><i class="layui-icon">&#xe640;</i>删除</a>
                <?php elseif($vv['type'] == 3): ?>
                <a href="<?php echo url('novel/deleteClass',['table'=>'class','id'=>$vv['id']]); ?>" class="layui-btn layui-btn-primary layui-btn-small"><i class="layui-icon">&#xe640;</i>删除</a>
                <?php endif; ?>
            </div>
        </dt>
        <dd>
            ...
            <dl class="menu-dl2">
                <dt>
                    <input type="checkbox" name="ids[<?php echo $kk; ?>]" value="<?php echo $vvv['id']; ?>" class="checkbox-ids" lay-skin="primary" title="<?php echo $vvv['name']; ?>">
                    <input type="text" class="menu-sort j-ajax-input" name="sort[<?php echo $kk; ?>]" onkeyup="value=value.replace(/[^\d]/g,'')" value="<?php echo $vvv['sort']; ?>" data-value="<?php echo $vvv['sort']; ?>" data-href="<?php echo url('khsort?table=class&ids='.$vvv['id']); ?>">
                    <input type="checkbox" name="status" value="<?php echo $vvv['status']; ?>" <?php if($vvv['status'] == 1): ?>checked=""<?php endif; ?> lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('khstatus?table=class&ids='.$vvv['id']); ?>">
                    <div class="menu-btns" style="left: 198px;">
                        <input type="checkbox" name="statu" value="<?php echo $vvv['home_dispay']; ?>" <?php if($vvv['home_dispay'] == 1): ?>checked=""<?php endif; ?> lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('khstatus?table=class&field=home_dispay&ids='.$vvv['id']); ?>">
                   </div>
                    <div class="menu-bt">
                        <a href="<?php echo url('classedit',['id'=>$vvv['id'],'type'=>$type]); ?>" title="编辑"><i class="layui-icon">&#xe642;</i></a>
                        <?php if($vvv['type'] == 1): ?>
                        <a href="<?php echo url('video/deleteClass',['table'=>'class','id'=>$vvv['id']]); ?>" class="layui-btn layui-btn-primary layui-btn-small "><i class="layui-icon">&#xe640;</i>删除</a>
                        <?php elseif($vvv['type'] == 2): ?>
                        <a href="<?php echo url('image/deleteClass',['table'=>'class','id'=>$vvv['id']]); ?>" class="layui-btn layui-btn-primary layui-btn-small "><i class="layui-icon">&#xe640;</i>删除</a>
                        <?php elseif($vvv['type'] == 3): ?>
                        <a href="<?php echo url('novel/deleteClass',['table'=>'class','id'=>$vvv['id']]); ?>" class="layui-btn layui-btn-primary layui-btn-small "><i class="layui-icon">&#xe640;</i>删除</a>
                        <?php endif; ?>
                    </div>
                </dt>
                <?php 
