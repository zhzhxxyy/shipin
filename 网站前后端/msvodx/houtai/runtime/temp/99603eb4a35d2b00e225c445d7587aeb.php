<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"/www/wwwroot/msvodx/houtai/app/admin/view/image/batch_edit.php";i:1512094470;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <tr id="ide">
            <td colspan="2">
                <div class="layui-form-item"  >
                    ...
                    <input type="text" style="width: 50%; float: left;" class="layui-input" name="id" value="<?php echo $ids; ?>" style="float: right" autocomplete="off" placeholder="0" >
                </div>
            </td>
        </tr>
