...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <form class="layui-form layui-form-pane" action="#" id="editForm" method="post">
        <div class="layui-collapse page-tips">
            <div class="layui-colla-item">
                ...
                <div class="layui-colla-content layui-show">
                    ...
                    <p>2. 单条规则：链接名称|网址,例：<span style="background-color: #000;color:#FFF;border-radius: 5px;padding:2px 5px;">baidu|http://www.msvod.cc</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div>
                <textarea class="layui-input" name="friend_link" style="height:300px;"><?php echo $config['friend_link']; ?></textarea>
            </div>
        </div>
