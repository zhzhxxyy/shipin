...
<div class="layui-row layui-col-space10">
    <div class="layui-col-md3 panel">
        ...
        <div class="panel_word">
            <h3><a title="管理" href="<?php echo url('admin/video/lists'); ?>"><?php echo $data['videocount']; ?></a></h3>/部
            <p><a title="去审核" href="/admin.php/admin/video/videocheck.html"><?php echo $data['videoshenhe']; ?>/待审</a></p>
        </div>
    </div>
    <div class="layui-col-md3 panel">
        ...
        <div class="panel_word">
            <h3><a title="管理" href="<?php echo url('admin/image/lists'); ?>"><?php echo $data['atlascount']; ?></a></h3>/个
            <p><a title="去审核" href="/admin.php/admin/image/imgcheck.html"><?php echo $data['atlasshenhe']; ?>/待审</a></p>
        </div>
    </div>
    <div class="layui-col-md3 panel">
        ...
        <div class="panel_word">
            <h3><a title="管理" href="<?php echo url('admin/novel/lists'); ?>"><?php echo $data['novelcount']; ?></a></h3>/条
            <p><a title="去审核" href="/admin.php/admin/novel/novelcheck.html"><?php echo $data['novelshenhe']; ?>/待审</a></p>
        </div>
    </div>
    <div class="layui-col-md3 panel">
        ...
        <div class="panel_word">
            <h3><a title="管理" href="/admin.php/admin/member/index"><?php echo $data['membercount']; ?></a></h3>/个
        </div>
    </div>
</div>
