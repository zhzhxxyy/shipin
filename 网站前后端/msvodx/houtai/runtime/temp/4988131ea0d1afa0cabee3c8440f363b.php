...
<form id="pageListForm">
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                <td><input type="checkbox" name="ids[]" class="layui-checkbox checkbox-ids" value="<?php echo $vo['order_sn']; ?>" lay-skin="primary"></td>
                <td class="font12">
                    <img src="<?php if($vo['headimgurl']): ?><?php echo $vo['headimgurl']; else: ?>__ADMIN_IMG__/avatar.png<?php endif; ?>" width="60" height="60" class="fl">
                    <p class="ml10 fl"><strong class="mcolor">昵称：<?php echo $vo['nickname']; ?> </strong><br>手机：<?php echo $vo['tel']; ?><br>邮箱：<?php echo $vo['email']; ?></p>
                </td>
                <td class="font12"><?php echo $vo['order_sn']; ?></td>
                <td class="font12"><?php if($vo['buy_type']==2): ?>购买VIP<?php elseif($vo['buy_type']===1): ?>充值金币<?php endif; ?></td>
                <td class="font12">
                    <!--充值描述 start-->
                    <?php if($vo['buy_type']==2): ?>
                        <div>
                            套餐名称: <span class="layui-badge layui-bg-black"><?php echo $vo['buy_vip_info']['name']; ?></span> <br />
                            会员期限: <span class="layui-badge layui-bg-black"><?php if($vo['buy_vip_info']['permanent']===1): ?>永久<?php else: ?><?php echo $vo['buy_vip_info']['days']; ?>天<?php endif; ?></span> <br />
                            套餐价格: <span class="layui-badge layui-bg-black"><?php echo $vo['buy_vip_info']['price']; ?></span> <br />
                        </div>
                    <?php elseif($vo['buy_type']===1): ?>
                        充值金币<span class="layui-badge layui-bg-black"><?php echo $vo['buy_glod_num']; ?></span>个
                    <?php endif; ?>
                    <!--充值描述 end-->
                </td>
                <td class="font12"><?php echo $vo['price']; ?>元</td>
                <td class="font12">下单时间：<?php echo date('Y-m-d H:i:s', $vo['add_time']); if(!(empty($vo['pay_time']) || (($vo['pay_time'] instanceof \think\Collection || $vo['pay_time'] instanceof \think\Paginator ) && $vo['pay_time']->isEmpty()))): ?><br>支付时间：<?php echo date('Y-m-d H:i:s', $vo['pay_time']); endif; ?></td>
                <td class="font12">
                    <?php if($vo['status'] == 1): ?>
