...
<div class="page-toolbar" >
    <div class="layui-btn-group fl">
        <a data-href="<?php echo url('status?table=agent_apply&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-qiyong"></i>通过</a>
        <a data-href="<?php echo url('status?table=agent_apply&val=2'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-jinyong1"></i>拒绝</a>
        <a data-href="<?php echo url('del?table=agent_apply'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm"><i class="aicon ai-jinyong"></i>删除</a>
    </div>
</div>
            ...
            <tr>
                ...
                <td>
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                        <a data-href="<?php echo url('del?table=agent_apply&ids='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                        </div>
                    </div>
                </td>
            </tr>
