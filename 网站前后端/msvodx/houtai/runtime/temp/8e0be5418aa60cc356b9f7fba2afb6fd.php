...
<form class="page-list-form">
    <div class="page-toolbar">
        <div class="layui-btn-group fl">
            <a href="<?php echo url('add'); ?>" class="layui-btn layui-btn-primary"><i class="aicon ai-tianjia"></i>添加菜单</a>
            <a data-href="<?php echo url('status?table=menu&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-qiyong"></i>启用</a>
            <a data-href="<?php echo url('status?table=menu&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-jinyong1"></i>禁用</a>
        </div>
    </div>
    ...
    <dl class="menu-dl1">
        <dt>
            ...
            <input type="text" class="menu-sort j-ajax-input" name="sort[<?php echo $kk; ?>]" onkeyup="value=value.replace(/[^\d]/g,'')" value="<?php echo $vv['sort']; ?>" data-value="<?php echo $vv['sort']; ?>" data-href="<?php echo url('sort?table=menu&ids='.$vv['id']); ?>">
            <input type="checkbox" name="status" value="<?php echo $vv['status']; ?>" <?php if($vv['status'] == 1): ?>checked=""<?php endif; ?> lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('status?table=menu&ids='.$vv['id']); ?>">
            <div class="menu-btns">
                <a href="<?php echo url('edit',['id'=>$vv['id']]); ?>" title="编辑"><i class="layui-icon">&#xe642;</i></a>
                <a href="<?php echo url('add',['id'=>$vv['id']]); ?>" title="添加子菜单"><i class="layui-icon">&#xe654;</i></a>
                <a href="<?php echo url('del?table=menu&ids='.$vv['id']); ?>" class="j-dt-del" title="删除"><i class="layui-icon">&#xe640;</i></a>
            </div>
        </dt>
        <dd>
            <?php 
            ...
            <dl class="menu-dl2">
                <dt>
                    ...
                    <input type="text" class="menu-sort j-ajax-input" name="sort[<?php echo $kk; ?>]" onkeyup="value=value.replace(/[^\d]/g,'')" value="<?php echo $vvv['sort']; ?>" data-value="<?php echo $vvv['sort']; ?>" data-href="<?php echo url('sort?table=menu&ids='.$vvv['id']); ?>">
                    <input type="checkbox" name="status" value="<?php echo $vvv['status']; ?>" <?php if($vvv['status'] == 1): ?>checked=""<?php endif; ?> lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('status?table=menu&ids='.$vvv['id']); ?>">
                    <div class="menu-btns">
                        <a href="<?php echo url('edit',['id'=>$vvv['id']]); ?>" title="编辑"><i class="layui-icon">&#xe642;</i></a>
                        <a href="<?php echo url('del?table=menu&ids='.$vvv['id']); ?>" class="j-dt-del" title="删除"><i class="layui-icon">&#xe640;</i></a>
                    </div>
                </dt>
                <?php 
                $kk++;
