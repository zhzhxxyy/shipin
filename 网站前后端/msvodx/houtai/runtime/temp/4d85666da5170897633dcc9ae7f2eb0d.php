...
<form id="pageListForm" class="layui-form layui-form-pane" method="get">
    <div class="layui-btn-group">
        <a href="<?php echo url('upload'); ?>" class="layui-btn layui-btn-primary"><i class="aicon ai-tianjia"></i>添加</a>
        <a data-href="<?php echo url('khstatus?table=video&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-qiyong"></i>启用</a>
        <a data-href="<?php echo url('khstatus?table=video&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-jinyong1"></i>禁用</a>
        <a data-href="<?php echo url('khdel?table=video'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm"><i class="aicon ai-jinyong"></i>删除</a>
    </div>
<div  style="margin-left: 10px; display: inline-block;float: right; ">
        <div class="layui-input-inline">
            <select name="select" lay-verify="">
                <option value="1"<?php if($select == 1): ?>  selected="selected"<?php endif; ?>>视频ID</option>
                <option value="2" <?php if($select == 2): ?>  selected="selected"<?php endif; ?>>视频名称</option>
    ...
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td>
                        ...
                        <img height="30" src="<?php echo $vo['thumbnail']; ?>" onmouseover="imgTips(this,{width:300})">
                        </a>
                </td>
                ...
                <td>
                    <input type="checkbox"  <?php if($vo['status'] == 1): ?>checked=""<?php endif; ?> value="<?php echo $vo['status']; ?>" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('khstatus?table=video&ids='.$vo['id']); ?>">
                </td>
                <td>
                    <div class="layui-btn-group">
                        <a href="<?php echo url('admin/video/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-primary layui-btn-small"><i class="layui-icon">&#xe642;</i></a>
                        <a data-href="<?php echo url('khdel?table=video&id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                        <a href="<?php echo url('admin/video/play',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-primary layui-btn-small j-iframe-poq" title="预览视频-《<?php echo $vo['title']; ?>》">预览</a>
                    </div>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="pagination" style="float: left;">
            <a href="<?php echo url('admin/video/randclick?callback=rand'); ?>" class="layui-btn layui-btn-primary j-iframe-pop fl" title="随机点击">随机点击</a>
            <a href="<?php echo url('admin/video/batch_edit'); ?>" class="layui-btn layui-btn-primary j-iframe-poq fl" title="批量修改">批量修改</a>
       </div>
        <?php echo $pages; ?>
    </div>
</form>
