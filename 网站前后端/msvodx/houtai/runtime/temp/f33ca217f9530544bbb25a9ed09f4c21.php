...
<form id="pageListForm">
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tbody>
            <?php if(is_array($data_list) || $data_list instanceof \think\Collection || $data_list instanceof \think\Paginator): $i = 0; $__LIST__ = $data_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;$giftinfo = json_decode($vo['gift_info'],true);?>
            <tr>
                ...
                <td class="font12">花费了<?php echo $giftinfo['price']; ?>金币，打赏了一个<?php echo $giftinfo['name']; ?><img style="width:36px;vertical-align:middle;margin-left: 5px;" src="<?php echo $giftinfo['images']; ?>"></td>
                <td class="font12">打赏时间：<?php echo date('Y-m-d H:i:s', $vo['gratuity_time']); ?></td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
        </table>
