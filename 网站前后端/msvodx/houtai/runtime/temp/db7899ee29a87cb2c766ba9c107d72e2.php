...
<input value="<?php echo $type; ?>" name="type" type="hidden"/>
                <input type="text" class="layui-input field-username"  lay-verify="required" autocomplete="off" disabled value="<?php if($type == 1): ?>视频标签<?php elseif($type == 2): ?>图片标签<?php elseif($type == 3): ?>资讯标签<?php endif; ?>">
...
<div class="layui-form-item">
    <div class="layui-input-block">
        ...
        <a href="<?php echo url('index/taglist',['t'=>'list']); ?>" class="layui-btn layui-btn-primary ml10"><i class="aicon ai-fanhui"></i>返回</a>
    </div>
</div>
</form>
<script>
