<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/msvodx/houtai/app/admin/view/poster/edit_poster.php";i:1516690194;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta http-equiv="Access-Control-Allow-Origin" content="*">
    <link rel="stylesheet" href="__ADMIN_JS__/layui/css/layui.css">
    <link rel="stylesheet" href="__ADMIN_CSS__/style.css?v=<?php echo time(); ?>">
    <style>
       span{
            display: none;
        }
...
<form  class="page-list-form layui-form layui-form-pane" style=" margin-left: 20px;" method="post" id="saveImgForm">
        ...
        <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="position" lay-verify="">
                        ...
                        <option value="<?php echo $v['id']; ?>"  <?php if($data['position_id'] == $v['id']): ?>selected="selected"<?php endif; ?> ><?php echo $v['title']; ?></option>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                ...
                <input type="hidden" value="<?php echo $data['type']; ?>" name="type" id="code">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="titles" value="<?php echo $data['titles']; ?>" autocomplete="off" >
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="info" value="<?php echo $data['info']; ?>" autocomplete="off" >
            </div>
    ...
    <div class="layui-form-item code1">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="content"  id="titlepic"  value="<?php echo $data['content']; ?>" autocomplete="off" >
            </div>
            <div class="layui-input-inline">
    ...
    <div class="layui-form-item code2" style="display: none;">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <textarea type="text" class="layui-input" name="code" value="<?php echo $data['content']; ?>" autocomplete="off" ></textarea>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="url" value="<?php echo $data['url']; ?>" autocomplete="off" >
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="radio" name="target" value="1" title="是" <?php if($data['target'] == 1): ?>checked<?php endif; ?>>
                <input type="radio" name="target" value="0" title="否" <?php if($data['target'] == 0): ?>checked<?php endif; ?>>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="date"  class="layui-input" id="test6" value="<?php echo date('Y-m-d',$data['begin_time']); ?> - <?php echo date('Y-m-d',$data['end_time']); ?>"  placeholder="<?php echo date('Y-m-d',$data['begin_time']); ?> - <?php echo date('Y-m-d',$data['end_time']); ?>">
            </div>
        </div>
    <div class="layui-form-item">
