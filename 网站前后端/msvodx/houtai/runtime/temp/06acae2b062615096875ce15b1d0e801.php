...
<form id="pageListForm">
    <div class="layui-btn-group">
        <a title="广告位添加" href="<?php echo url('admin/poster/add'); ?>" class="layui-btn layui-btn-primary j-iframe-poq"><i class="aicon ai-tianjia"></i>添加</a>
    </div>
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td class="font12">
                    <p class="ml10 fl"><strong class="mcolor">广告位标题：<?php echo $vo['title']; ?> </strong></p>
                </td>

                <td class="font12">
                    <?php echo $vo['width']; ?>×<?php echo $vo['height']; ?>
                </td>
                <td class="font12">
                    <a href="<?php echo url('del?table=advertisement_position&id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                    <a href="<?php echo url('admin/poster/edit',['id'=>$vo['id']]); ?>"  title="编辑"   class="layui-btn layui-btn-primary layui-btn-small j-iframe-pop"><i class="layui-icon">&#xe642;</i></a>
                    <a   class="layui-btn layui-btn-primary layui-btn-small show" data-id="<?php echo $vo['id']; ?>" title="查看代码"><i class="layui-icon">&#xe609;</i></a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
