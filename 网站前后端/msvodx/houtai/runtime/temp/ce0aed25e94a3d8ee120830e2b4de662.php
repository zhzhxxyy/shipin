...
<form id="pageListForm" class="layui-form layui-form-pane" method="get">
    <div class="layui-btn-group">
        ...
        <a data-href="<?php echo url('del?table=card_password'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm"><i class="aicon ai-jinyong"></i>删除</a>
    </div>
    <div  style="margin-left: 10px; display: inline-block;float: right; ">
        <div class="layui-input-inline">
            <select name="card_type" lay-verify=""  lay-filter="filter" >
                ...
                <option value="1" <?php if($card_type == 1): ?>  selected="selected"<?php endif; ?>>会员卡</option>
                <option value="2" <?php if($card_type == 2): ?>  selected="selected"<?php endif; ?>>金币卡</option>
            </select>
        </div>
        <div class="layui-input-inline">
            <select name="status" lay-verify=""  lay-filter="filter">
                <option value="0">使用状态</option>
                <option value="1" <?php if($status == 1): ?>  selected="selected"<?php endif; ?>>已使用</option>
                <option value="2" <?php if($status == 0): ?>  selected="selected"<?php endif; ?>>未使用</option>
            </select>
        </div>
        <div class="layui-input-inline">
            <a class="layui-btn layui-btn-primary" href="<?php echo url('export',array('condition'=>urlencode($where))); ?>" target="_blank">导出当前所有数据</a>
        </div>
        ...
        <!--<div class="layui-input-inline">
            <select name="card_type" lay-verify="">
                ...
                <option value="1" <?php if($status == 1): ?>  selected="selected"<?php endif; ?>>过期时间</option>
                <option value="2" <?php if($status == 0): ?>  selected="selected"<?php endif; ?>>添加时间</option>
            </select>
        </div>-->
    </div>
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <th>
                    价格
                    <span class="layui-table-sort layui-inline" <?php if($order == 'price_desc'): ?> lay-sort="desc"<?php endif; if($order == 'price_asc'): ?> lay-sort="asc"<?php endif; ?> >
                ...
                <th>
                    过期时间
                    <span class="layui-table-sort layui-inline" <?php if($order == 'out_time_desc'): ?> lay-sort="desc"<?php endif; if($order == 'out_time_asc'): ?> lay-sort="asc"<?php endif; ?> >
                ...
                <th>
                    添加时间
                    <span class="layui-table-sort layui-inline" <?php if($order == 'add_time_desc'): ?> lay-sort="desc"<?php endif; if($order == 'add_time_asc'): ?> lay-sort="asc"<?php endif; ?> >
            ...
            <tr>
                ...
                <td >
                    <?php echo $vo['card_number']; ?>
                </td>
                <td >
                    <?php if($vo['card_type']==2): ?>
                    金币卡
                ...
                <td >
                    <?php if($vo['card_type']==2): ?>
                    <?php echo $vo['gold']; ?>金币
                    <?php elseif($vo['card_type']===1): if($vo['vip_time']==999999999): ?>
                        永久vip
                        <?php else: ?>
                         vip<?php echo $vo['vip_time']; ?>天
                        <?php endif; endif; ?>
                </td>
                ...
                <td ><?php echo date('Y-m-d H:i', $vo['out_time']); ?></td>
                <td ><?php echo date('Y-m-d H:i', $vo['add_time']); ?></td>
                <td style="text-align: center">
                    <div class="layui-btn-group" >
                        <a data-href="<?php echo url('del?table=card_password&id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                    </div>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
