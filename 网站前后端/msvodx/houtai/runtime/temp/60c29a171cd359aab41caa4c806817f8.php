    ...
    <form class="layui-form layui-form-pane" action="<?php echo url(''); ?>" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" min="1" max="10" class="layui-input" name="video_commission" value="<?php echo $config['video_commission']; ?>" autocomplete="off" placeholder="请填写1-100的数字">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" min="1" max="10" class="layui-input" name="atlas_commission" value="<?php echo $config['atlas_commission']; ?>" autocomplete="off" placeholder="请填写1-100的数字">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" min="1" max="10" class="layui-input" name="novel_commission" value="<?php echo $config['novel_commission']; ?>" autocomplete="off" placeholder="请填写1-100的数字">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" min="1" max="100" class="layui-input" name="agent_commission" value="<?php echo $config['agent_commission']; ?>" autocomplete="off" placeholder="请填写1-100的数字">
            </div>
