    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="pid" class="field-pid" type="select" lay-filter="pai">
                ...
                <option value="<?php echo $v['id']; ?>" level="<?php echo $v['id']; ?>" <?php if($classinfo['id'] == $v['id']): ?>   selected="selected" <?php endif; ?>><?php echo $v['name']; ?></option>
