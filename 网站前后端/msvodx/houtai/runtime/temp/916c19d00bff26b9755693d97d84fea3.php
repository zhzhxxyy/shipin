<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"/www/wwwroot/msvodx/houtai/app/admin/view/index/iframe.php";i:1564651146;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
                ...
                <li class="layui-nav-item <?php if($kk == 1): ?>layui-nav-itemed<?php endif; ?>">
                    ...
                    <dl class="layui-nav-child">
                        <?php if($vv['title'] == '快捷菜单'): ?>
                            <dd><a class="admin-nav-item" data-id="0" href="<?php echo url('admin/index/welcome'); ?>">后台首页</a></dd>
