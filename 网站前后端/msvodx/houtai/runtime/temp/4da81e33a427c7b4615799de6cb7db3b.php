...
<div class="page-toolbar" style="overflow: visible">
    <div class="layui-btn-group fl">
        ...
        <a data-href="<?php echo url('status?table=member&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-qiyong"></i>启用</a>
        <a data-href="<?php echo url('status?table=member&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-jinyong1"></i>禁用</a>
        <a data-href="<?php echo url('del?table=member'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm"><i class="aicon ai-jinyong"></i>删除</a>
    </div>
    <div class="fr">
            ...
            <div class="layui-form-item ">
                <div class="layui-input-inline layui-form">
                    <select name="member_type" lay-verify="">
                        ...
                        <option value="1"  <?php if($member_type == 1): ?>selected="selected"<?php endif; ?> >普通用户</option>
                        <option value="2"  <?php if($member_type == 2): ?>selected="selected"<?php endif; ?> >所有vip</option>
                        <option value="3"  <?php if($member_type == 3): ?>selected="selected"<?php endif; ?> >普通vip</option>
                        <option value="4"  <?php if($member_type == 4): ?>selected="selected"<?php endif; ?>>永久vip</option>
                    </select>
                </div>
                <div class="layui-input-inline layui-form">
                    <select name="key" lay-verify="">
                        <option value="nickname" <?php if($keys == 'nickname'): ?>selected="selected"<?php endif; ?>>昵称</option>
                        <option value="tel" <?php if($keys == 'tel'): ?>selected="selected"<?php endif; ?> >手机号</option>
                        <option value="email" <?php if($keys == 'email'): ?>selected="selected"<?php endif; ?>>邮箱</option>
                    </select>
                </div>
                <div class="layui-input-inline">
                    <input type="text" name="keyword" lay-verify="required" placeholder="请输入关键词搜索" autocomplete="off" class="layui-input" value="<?php echo (isset($keyword) && ($keyword !== '')?$keyword:""); ?>" >
                </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="font12">
                    ...
                    <p class="ml10 fl"><?php echo $vo['nickname']; ?> &nbsp; (<?php echo $vo['username']; ?>)<br>手机：<?php echo (isset($vo['tel']) && ($vo['tel'] !== '')?$vo['tel']:"-"); ?><br>邮箱：<?php echo $vo['email']; ?></p>
                </td>
                <td class="font12"><?php if($vo['is_permanent']==1): ?>永久VIP<?php elseif($vo['out_time']>time()): ?>VIP<?php else: ?>普通用户<?php endif; ?></td>
                <td class="font12">余额：<?php echo $vo['money']; ?></td>
                <td class="font12">注册：<?php echo date('Y-m-d H:i:s', $vo['add_time']); ?><br>登陆：<?php echo date('Y-m-d H:i:s', $vo['last_time']); ?></td>
                <td><input type="checkbox" name="is_agent" <?php if($vo['is_agent'] == 1): ?>checked=""<?php endif; ?> value="<?php echo $vo['is_agent']; ?>" lay-skin="switch" lay-filter="switchStatus" lay-text="是|否" data-href="<?php echo url('isAgent?ids='.$vo['id']); ?>"></td>
                <td><input type="checkbox" name="status" <?php if($vo['status'] == 1): ?>checked=""<?php endif; ?> value="<?php echo $vo['status']; ?>" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('status?table=member&ids='.$vo['id']); ?>"></td>
                <td>
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                        <a href="<?php echo url('edit?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small"><i class="layui-icon">&#xe642;</i></a>
                        <a data-href="<?php echo url('del?table=member&ids='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                        </div>
                    </div>
                </td>
            </tr>
