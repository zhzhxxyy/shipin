    ...
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo $vo['app_icon']; ?>" target="pic">
                        <img height="30" src="<?php echo $vo['app_icon']; ?>" onmouseover="imgTips(this,{width:300})">
                    </a>
                </td>
                ...
                <td>
                    <div class="layui-btn-group">
                        <a href="<?php echo url('admin/fenfa/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-primary layui-btn-small"><i class="layui-icon">&#xe642;</i></a>
                        <a data-href="<?php echo url('khdel?table=share_app&id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                        <div onclick="copyUrl('<?php echo $vo['id']; ?>')" style="display: inline-block;
    height: 28px;
    line-height: 30px;
    padding: 0 10px;
    white-space: nowrap;
