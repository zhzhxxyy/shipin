...
<form id="pageListForm">
    <div class="layui-btn-group">
        <a href="<?php echo url('admin/banner/add'); ?>" class="layui-btn layui-btn-primary"><i class="aicon ai-tianjia"></i>添加</a>
        <a data-href="<?php echo url('khstatus?table=banner&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-qiyong"></i>启用</a>
        <a data-href="<?php echo url('khstatus?table=banner&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-jinyong1"></i>禁用</a>
        <a data-href="<?php echo url('khdel?table=banner'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm"><i class="aicon ai-jinyong"></i>删除</a>
    </div>
    ...
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td>
                        <img height="30" src="<?php echo $vo['images_url']; ?>" onmouseout="layer.closeAll();"  onmouseover="imgTips(this,{width:800})">
                </td>
                <td><?php echo $vo['name']; ?></td>
                <td><?php echo $vo['url']; ?></td>
                <td>
                    <input type="text" class="layui-input j-ajax-input input-sort" onkeyup="value=value.replace(/[^\d]/g,'')"
                           value="<?php echo $vo['sort']; ?>" data-value="" data-href="<?php echo url('khsort?table=banner&id='.$vo['id']); ?>">
                </td>
                <td><?php echo $vo['info']; ?></td>
                <td>
                    <input type="checkbox" name="status" <?php if($vo['status'] == 1): ?>checked=""<?php endif; ?> value="<?php echo $vo['status']; ?>" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('khstatus?table=banner&ids='.$vo['id']); ?>">
                </td>
                <td>
                    <div class="layui-btn-group">
                        <a href="<?php echo url('admin/banner/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-primary layui-btn-small"><i class="layui-icon">&#xe642;</i></a>
                        <a data-href="<?php echo url('khdel?table=banner&id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                    </div>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
