...
<div class="page-toolbar" >
    <div class="layui-btn-group fl">
        <a href="<?php echo url('addGoldPackage'); ?>" class="layui-btn layui-btn-primary"><i class="aicon ai-tianjia"></i>添加</a>
        <a data-href="<?php echo url('del?table=gold_package'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm"><i class="aicon ai-jinyong"></i>删除</a>
    </div>
</div>
    ...
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td class="font12"><?php echo $vo['gold']; ?></td>
                <td class="font12"><?php echo $vo['price']; ?></td>
                <td>
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                            <a href="<?php echo url('editGoldPackage?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small"><i class="layui-icon">&#xe642;</i></a>
                            <a data-href="<?php echo url('del?table=gold_package&ids='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                        </div>
                    </div>
                </td>
            </tr>
