...
<form id="pageListForm">
    <div class="layui-form">
        <div class="layui-btn-group">
            <a title="广告添加" href="<?php echo url('admin/poster/add_poster'); ?>" height="600" class="layui-btn layui-btn-primary j-iframe-poq"><i class="aicon ai-tianjia"></i>添加</a>
        </div>
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td class="font12">
                    <img src="<?php if($vo['content']): ?><?php echo $vo['content']; else: ?>__ADMIN_IMG__/avatar.png<?php endif; ?>" width="60" height="60" class="fl">
                    <p class="ml10 fl"><strong class="mcolor">广告位标题：<?php echo $vo['titles']; ?> </strong><br>类型：<?php if($vo['type'] == 2): ?>用户自定义<?php endif; if($vo['type'] == 1): ?>广告代码<?php endif; ?><br>说明：<?php echo $vo['info']; ?></p>
                </td>
                <td class="font12"><?php echo $vo['title']; ?></td>
                <td class="font12">
                    <p class="ml10 fl"><strong class="mcolor"><?php echo date('Y-m-d H:i:s', $vo['begin_time']); ?>-至-<?php echo date('Y-m-d H:i:s', $vo['end_time']); ?></strong>      <br>广告外链：<?php echo $vo['url']; ?><br></p>
                </td>
                <td class="font12">添加时间：<?php echo date('Y-m-d H:i:s', $vo['add_time']); ?>
                    <br>所属域名：<?php echo $vo['host']; ?><br></p>
                </td>
                <td class="font12">
                    <input type="checkbox"  <?php if($vo['status'] == 1): ?>checked=""<?php endif; ?> value="<?php echo $vo['status']; ?>" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('status?table=advertisement&ids='.$vo['id']); ?>">
                </td>
                <td class="font12">
                    <a href="<?php echo url('del?table=advertisement&id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                    <a href="<?php echo url('admin/poster/edit_poster',['id'=>$vo['id']]); ?>"  height="600" title="编辑" class="layui-btn layui-btn-primary layui-btn-small j-iframe-poq"><i class="layui-icon">&#xe642;</i></a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
