...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <form class="layui-form layui-form-pane" action="<?php echo url(''); ?>" id="editForm" method="post">
        <input type="hidden" name="id" value="<?php echo $payBaseInfo['id']; ?>">
        <div class="layui-form-item">
            <label class="layui-form-label">支付名称</label>
            <div class="layui-input-inline">
                <div class="layui-input-inline w200">
                    <input type="text" class="layui-input" name="pay_name" lay-verify="title" value="<?php echo $payBaseInfo['pay_name']; ?>" readonly>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <div class="layui-input-inline w200">
                    <input type="text" class="layui-input" name="pay_code" lay-verify="title" value="<?php echo $payBaseInfo['pay_code']; ?>" readonly>
                </div>
            </div>
        </div>
        <?php if(is_array($payParams) || $payParams instanceof \think\Collection || $payParams instanceof \think\Paginator): $i = 0; $__LIST__ = $payParams;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$param): $mod = ($i % 2 );++$i;?>
        <div class="layui-form-item">
            <label class="layui-form-label"><?php echo $param['desc']; ?></label>
            <div class="layui-input-inline">
                <div class="layui-input-inline w200">
                    <?php if(in_array($param['type'],['string','int'])): ?>
                        <input type="text" class="layui-input" name="<?php echo $param['name']; ?>" lay-verify="title" value="<?php echo $param['value']; ?>">
                    <?php else: ?>
                        <textarea class="layui-input" name="<?php echo $param['name']; ?>" lay-verify="title" style="height:300px;"><?php echo $param['value']; ?></textarea>
                    <?php endif; ?>
                </div>
            </div>
            <div class="layui-form-mid layui-word-aux"> <?php echo $param['name']; ?></div>
        </div>
        <?php endforeach; endif; else: echo "" ;endif; ?>
