...
<form action="#" class="page-list-form layui-form layui-form-pane" method="post">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="title" class="layui-input" name="video[title]" value="<?php echo $videoinfo['title']; ?>" autocomplete="off" placeholder="请填写">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="video[reco]" class="field-pid" type="select" lay-filter="pai">
                <option value="0" level="0" <?php if(0 == $videoinfo['reco']): ?>selected="selected"<?php endif; ?> >视频推荐</option>
                <option value="1" level="1" <?php if(1 == $videoinfo['reco']): ?>selected="selected"<?php endif; ?> >★☆☆☆☆</option>
                <option value="2" level="2" <?php if(2 == $videoinfo['reco']): ?>selected="selected"<?php endif; ?> >★★☆☆☆</option>
                <option value="3" level="3" <?php if(3 == $videoinfo['reco']): ?>selected="selected"<?php endif; ?> >★★★☆☆</option>
                <option value="4" level="4" <?php if(4 == $videoinfo['reco']): ?>selected="selected"<?php endif; ?> >★★★★☆</option>
                <option value="5" level="5" <?php if(5 == $videoinfo['reco']): ?>selected="selected"<?php endif; ?> >★★★★★</option>
            </select>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input" name="video[gold]" value="<?php echo $videoinfo['gold']; ?>" autocomplete="off" >
        </div>
...
<!--    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input" name="video[key_word]" value="<?php echo $videoinfo['key_word']; ?>" autocomplete="off" placeholder="请填写">
        </div>
    </div> -->
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 50%;">
            ...
            <input type="checkbox"  class="layui-checkbox checkbox-ids"  name="tag[]" <?php if(in_array($v['id'],$videoinfo['tag'])): ?>checked="checked" <?php endif; ?> value="<?php echo $v['id']; ?>" title="<?php echo $v['name']; ?>">
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="video[class]" class="field-pid" type="select" lay-filter="pai">
                ...
                <option value="<?php echo $v['id']; ?>" level="<?php echo $v['id']; ?>" <?php if($v['id'] == $videoinfo['class']): ?>selected="selected"<?php endif; ?> >|-<?php echo $v['name']; ?></option>
                ...
                <option value="<?php echo $vv['id']; ?>" level="<?php echo $vv['id']; ?>" <?php if($vv['id'] == $videoinfo['class']): ?>selected="selected"<?php endif; ?> >&nbsp;&nbsp;&nbsp;&nbsp;|-<?php echo $vv['name']; ?></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input" name="video[url]"  id="odownpath1" value="<?php echo $videoinfo['url']; ?>" autocomplete="off">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input" name="video[download_url]" id="downpath1" value="<?php echo $videoinfo['download_url']; ?>" autocomplete="off" >
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label layui-bg-gray">缩略图：</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input" name="video[thumbnail]"  id="titlepic"  value="<?php echo $videoinfo['thumbnail']; ?>" autocomplete="off" >
        </div>
        <div class="layui-input-inline">
            <a id="video_thumb_up_btn" href="javascript:" class="layui-btn layui-btn-primary" style="background-color: #fff;">更换</a>
            &nbsp;&nbsp; <img onmouseout="layer.closeAll();"  onmouseover="imgTips(this,{width:320})" style="border-radius:5px;border:1px solid #ccc;"  height="36" id="img_video_thumb" src="<?php echo $videoinfo['thumbnail']; ?>">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input" name="video[play_time]" id="playtime" id="playtime" value="<?php echo $videoinfo['play_time']; ?>" autocomplete="off" >
        </div>
    </div>
<!--    <div class="layui-form-item">
        <label class="layui-form-label layui-bg-gray">视频说明</label>
        <div class="layui-input-inline">
            <textarea rows="6"  class="layui-textarea" name="video[short_info]" autocomplete="off" placeholder="请填写视频说明"><?php echo $videoinfo['short_info']; ?></textarea>
        </div>
    </div> -->
    <div class="layui-form-item">
        <label class="layui-form-label  layui-bg-gray">视频简介:</label>
        <div class="layui-input-block">
            <textarea id="UEditor1" name="video[info]" style="width: 60%;"><?php echo $videoinfo['info']; ?></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
