...
<form id="pageListForm" class="layui-form">
    <div class="page-toolbar">
        <div class="layui-btn-group">
            ...
            <a data-href="<?php echo url('khstatus?table=notice&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-qiyong"></i>启用</a>
            <a data-href="<?php echo url('khstatus?table=notice&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-jinyong1"></i>禁用</a>
            <a data-href="<?php echo url('del?table=notice'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm"><i class="aicon ai-jinyong"></i>删除</a>
        </div>
    </div>
    <table class="layui-table mt10" lay-even="" lay-skin="row">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php if($vo['type'] == 1): ?><?php echo $vo['content']; else: ?><?php echo $vo['url']; endif; ?> </td>
                <td> <?php if($vo['type'] == 1): ?>弹出层显示<?php else: ?>网页转跳<?php endif; ?> </td>
                <td><?php echo date('Y-m-d H:i:s',$vo['out_time']); ?></td>
                <td><?php echo $vo['sort']; ?></td>
                <td>
                    <input type="checkbox"  <?php if($vo['status'] == 1): ?>checked=""<?php endif; ?> value="<?php echo $vo['status']; ?>" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('khstatus?table=notice&ids='.$vo['id']); ?>">
                </td>
                <td> 
                    <div class="layui-btn-group">
                        <a href="<?php echo url('edit?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small ">编辑</a>
                        <a data-href="<?php echo url('del?table=notice&ids='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del">删除</a>
                    </div>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
