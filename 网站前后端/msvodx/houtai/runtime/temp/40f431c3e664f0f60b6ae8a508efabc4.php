    ...
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="status" <?php if($payment['status'] == 1): ?>checked=""<?php endif; ?> value="<?php echo $payment['status']; ?>" lay-skin="switch" lay-filter="switchStatus" lay-text="开启|禁用" data-href="<?php echo url('status?table=payment&ids='.$payment['id']); ?>">
                    <!--<?php if($payment['status'] == 0): ?><span style="color: #c1c1c1;"><i class="layui-icon">&#x1006;</i> 已禁用</span><?php else: ?><span style="color:green"><i class="layui-icon">&#x1005;</i> 已启用</span><?php endif; ?>-->
                </td>
                <td><?php if(!empty($payment['add_time'])): ?><?php echo date("Y/m/d H:i:s",$payment['add_time']); else: ?> / <?php endif; ?></td>
                <td><?php if(!empty($payment['update_time'])): ?><?php echo date("Y/m/d H:i:s",$payment['update_time']); else: ?> / <?php endif; ?></td>
                <td style="text-align: left"><?php if($payment['is_third_payment'] == 1): ?><span style="color:green;"><i class="layui-icon">&#xe857;</i>  第三方支付</span><?php else: ?><span style="color:#ff913c;"><i class="layui-icon">&#xe617;</i>  原生支付</span><?php endif; ?></td>
                <td>
                    <div class="layui-btn-group">
                        <a href="<?php echo url('setting',array('id'=>$payment['id'])); ?>" title="支付参数配置" class="layui-btn layui-btn-primary layui-btn-small "><i class="layui-icon">&#xe642;</i>参数配置</a>
                    </div>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
