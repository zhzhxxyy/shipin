<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"./tpl/default/index/index.html";i:1519954746;s:32:"./tpl/default/common/header.html";i:1521865672;s:32:"./tpl/default/common/footer.html";i:1521865458;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<link href="__ROOT__/tpl/default/static/css/index.css" rel="stylesheet">
<script type="text/javascript" src="__ROOT__/tpl/default/static/js/index.js"></script>
<script>
...
<div class="s-body">
    ...
    <div class="copyright-tips">
        <div class="layout-cont">
            <span><i class="btn fn-gonggao"></i> &nbsp;公告：</span>
            <ul>
    ...
    <div class="content">
        ...
        <div class="left-box">
            <div class="mod-new">
                <div class="title"><h2>推荐视频</h2></div>
                <div class="mod-row">
                    ...
                    <div class="mod-col">
                        ...
                        <p class="col-title"><?php echo $vo['title']; ?></p>
                        <div class="subtitle">
                            <i class="btn fn-see"></i><?php echo $vo['click']; ?>
                            <div style="display: inline-block;"><i class="btn fn-jinbi1" style="margin-left: 5px;"></i><?php echo $vo['gold']; ?></div>
            ...
            <?php if(is_array($video_list) || $video_list instanceof \think\Collection || $video_list instanceof \think\Paginator): $i = 0; $__LIST__ = $video_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(!(empty($vo['list']) || (($vo['list'] instanceof \think\Collection || $vo['list'] instanceof \think\Paginator ) && $vo['list']->isEmpty()))): ?>
                    <div class="mod-new">
                        <div class="title"><h2><?php echo $vo['name']; ?></h2></div>
                        <div class="mod-row">
                            ...
                            <div class="mod-col">
                                <a href="<?php echo url('video/play',array('id'=>$v['id'])); ?>">
                                    <div class="view-layer">
                                        <img src="<?php echo $v['thumbnail']; ?>"/>
                                        <p><?php echo $v['play_time']; ?></p>
                                        <div class="play-bg"><span><i></i></span></div>
                                    </div>
                                </a>
                                <p class="col-title"><?php echo $v['title']; ?></p>
                                <div class="subtitle">
                                    <i class="btn fn-see"></i><?php echo $v['click']; ?>
                                    <i class="btn fn-jinbi1" style="margin-left: 5px;"></i><?php echo $v['gold']; ?>
                ...
                <?php endif; endforeach; endif; else: echo "" ;endif; if(is_array($image_list) || $image_list instanceof \think\Collection || $image_list instanceof \think\Paginator): $i = 0; $__LIST__ = $image_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(!(empty($vo['list']) || (($vo['list'] instanceof \think\Collection || $vo['list'] instanceof \think\Paginator ) && $vo['list']->isEmpty()))): ?>
            <div class="mod-new">
                <div class="title"><h2><?php echo $vo['name']; ?></h2></div>
                <div class="mod-row images">
                    <?php if(is_array($vo['list']) || $vo['list'] instanceof \think\Collection || $vo['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <div class="mod-col">
                        <a href="<?php echo url('images/show',array('id'=>$v['id'])); ?>">
                            <div class="pic-layer">
                                ...
                                <div class="subtitle">
                                    <i class="btn fn-see"></i><?php echo $v['click']; ?>
                                    <i class="btn fn-jinbi1" style="margin-left: 5px;"></i><?php echo $v['gold']; ?>
                                    <span><i  class="btn fn-time"></i><?php echo date('Y-m-d',$v['update_time']); ?></span>
                                </div>
                            </div>
                        </a>
                        <p class="col-title"><?php echo $v['title']; ?></p>
           ...
           <!-- <?php if(is_array($novel_list) || $novel_list instanceof \think\Collection || $novel_list instanceof \think\Paginator): $i = 0; $__LIST__ = $novel_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(!(empty($vo['list']) || (($vo['list'] instanceof \think\Collection || $vo['list'] instanceof \think\Paginator ) && $vo['list']->isEmpty()))): ?>
            <div class="mod-new">
                <div class="title"><h2><?php echo $vo['name']; ?></h2></div>
                <div class="mod-row novel-list">
                    <ul>
                        <?php if(is_array($vo['list']) || $vo['list'] instanceof \think\Collection || $vo['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <li>
                            <a href="<?php echo url('novel/show',array('id'=>$v['id'])); ?>">
                                <p><?php echo $v['title']; ?></p>
                                <span><?php echo date('Y-m-d',$v['update_time']); ?></span>
                            </a>
                        </li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
        ...
        <div class="right-box">
            <!--排行榜-->
            <div class="newest">
                <a href="<?php echo url('video/lists',array('orderCode'=>'hot')); ?>" class="s-title">最热视频 <i></i></a>
                <ul>
                ...
                <div class="home-r-rank-footer">
                    <a href="<?php echo url('video/lists',array('orderCode'=>'hot')); ?>" class="uhl">查看更多></a>
                </div>
            </div>
            <div class="newest new">
                <a href="<?php echo url('video/lists',array('orderCode'=>'lastTime')); ?>" class="s-title on">最新视频<i></i></a>
                <ul>
                    ...
                    <li>
                        ...
                        <p><?php echo $vo['title']; ?></p>
                        <p class="content-like">
                            <span class="mod-like"><i class="btn fn-time"></i><?php echo date('Y-m-d',$vo['update_time']); ?></span>
                            <span class="mod-like" style="float: right;"><i class="btn fn-zan2"></i><?php echo $vo['good']; ?></span>
                        </p>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <div class="home-r-rank-footer">
                    <a href="<?php echo url('video/lists',array('orderCode'=>'lastTime')); ?>" class="uhl">查看更多></a>
                </div>
            </div>
        </div>
    </div>
