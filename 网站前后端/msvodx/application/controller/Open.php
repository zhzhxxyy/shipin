...
class Open extends BaseController
{
    ...
    public function login(Request $request){
      //  var_dump($_SERVER);die;
        ...
        Cookie::set('log_fhurl',$_SERVER['REDIRECT_URL'],1800);//来源路径
    ...
    public function wechat_login($log_state=''){
        ...
        $login_url='https://open.weixin.qq.com/connect/qrconnect?appid='.$config['APPID'].'&redirect_uri='.$this->redirect_uri.'&response_type=code&scope=snsapi_login&state='.$log_state.'#wechat_redirect';
