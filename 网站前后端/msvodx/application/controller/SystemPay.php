...
class SystemPay extends BaseController
{
    ...
    public function recharge(Request $request)
    {
        ...
        switch ($curSysPayCode) {
            case 'codePay':
                ...
                $paymentList[] = ['payName' => '支付宝支付', 'payCode' => 'codePay|aliPay', 'payIcon' => '/tpl/default/static/images/Alipay.png'];
                $paymentList[] = ['payName' => '微信支付', 'payCode' => 'codePay|wxPay', 'payIcon' => '/tpl/default/static/images/WeChat.png'];
                $paymentList[] = ['payName' => 'QQ钱包', 'payCode' => 'codePay|qqPay', 'payIcon' => '/tpl/default/static/images/QQ.png'];
                break;
            case 'nativePay':
                ...
                foreach ($nativeList as $item) {
                    switch ($item['pay_code']) {
                        case 'wxPay':
                            $paymentList[] = ['payName' => '微信支付', 'payCode' => 'nativePay|wxPay', 'payIcon' => '/tpl/default/static/images/WeChat.png'];
                            break;
                        case 'aliPay':
                            $paymentList[] = ['payName' => '支付宝支付', 'payCode' => 'nativePay|aliPay', 'payIcon' => '/tpl/default/static/images/Alipay.png'];
                            break;
                    }
                }
                break;
    ...
    public function pay(Request $request)
    {
        ...
        if (strtolower($order->payment_code) != 'nativepay') {
            //not native payment
