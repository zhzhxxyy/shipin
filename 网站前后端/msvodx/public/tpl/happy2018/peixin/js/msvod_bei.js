...
/* COMBO: filename = js/public.53.js, type = application/javascript, resp = 200 */
function ConfigFun() {
var host = '/';
var config = {
...
course.getCourseAll = function (type, page, replyId, $) {
$.ajax({
type: 'POST',
url: Url.getCourseAll,
dataType: 'json',
data: {
...
//0全部 1只评论  2只推荐视频 3只学习动态
if (0 === type) {
document.getElementById('course-review').innerHTML = template('course-review-js', message.info.commentList);
$("#loading").addClass('hide');
document.getElementById('lately-list').innerHTML = template('lately-list-js', message.info.latelyList);
document.getElementById('recomend-box-ul').innerHTML = template('recomended-body-js', message.info.videoRankInfo);
$(".page-container").empty();
$(".page-container").html(message.info.pageHtml);
initCommentHtml(replyId, page);
...
course.getCourseAll(1, parseInt(page), 0, jQuery);
$(".page-list .page_click_class").removeClass('on').removeClass('active');
$(".page-list .page_click_class[data-page=page]").addClass('on active');
course.scroll();
Param.pages = parseInt(page) + 1;
});

exposure.sids = message.info.videoRankInfo.idlist;
$('div[data-template-js="lately-list"]').removeClass('hide');
if (message.info.playVideo) $('#no-learn-reply-win-js').remove()
}
})
};
...
/* COMBO: filename = js/countUp.min.js, type = application/javascript, resp = 200 */
...
/* COMBO: filename = js/home/home.v11.js, type = application/javascript, resp = 200 */
/**
* Created by Mr.D on 2017/6/7.
*/
