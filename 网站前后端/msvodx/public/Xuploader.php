...
if (!file_exists($targetDir)) {
    ...
    #@mkdir($targetDir);
    #@chmod($targetDir,0766);
}
$allowFileType=['jpg','gif','png','jpeg', 'rmvb','flv','mp4','mov','3gp','wmv','mp3','avi','mpeg','ico','apk','ipa'];
...
if (isset($_REQUEST["name"])) {
    ...
    if(!in_array($_tmpType,$allowFileType)) die('{"jsonrpc" : "2.0", "error" : {"code": 102, "message": "Error file  ."}, "id" : "id"}');
} elseif (!empty($_FILES)) {
