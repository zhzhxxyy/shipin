...
export default class BaseFlatListComponent extends BaseComponent {
    ...
    // dataSource = new FlatList.DataSource({ rowHasChanged: (r1, r2) => r1 !== r2 })
    ...
    initData() {
        ...
        requestAction.then(res => {
            ...
            let arrays = res;//this.filterResponse(res);
            ...
            Alert.alert("xiaoor hou zi"+error);
            if (this.pageIndex == 1) {
    ...
    renderComponent() {
        return (
            <FlatList
                ...
                ListHeaderComponent={this.renderFlatViewHeader}
                ListFooterComponent={this.renderFlatViewFooter}>
            </FlatList>
        );
    }
}
