...
export default class TradingRecordAll extends Component {
    ...
    getDataList(isReload){
        ...
        let codeurl = host + '/AppAccount.dealRecord.p.'+this.state.currentPage+'.do?type=allfunds';
        let formData = new FormData();
        // formData.append("type","allfunds");//获取洗码记录列表
