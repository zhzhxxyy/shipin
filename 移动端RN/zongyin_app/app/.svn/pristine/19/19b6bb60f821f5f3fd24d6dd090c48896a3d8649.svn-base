...
export default class MyIncome extends React.Component {
    ...
    getDataList(isReload){
        ...
        let key = key = '/fubi/purchase/getUsersEarningList';
        let formData = new FormData();
        // if(this.props.tabLabel == '打赏'){
        //
        //     key = '/fubi/purchase/getUsersConsumeList'
        //     formData.append('type','gift');
        // }else{
        //     formData.append('type','consume');
        //     formData.append('consumeType','gift');
        // }
        let codeurl = host + key;
