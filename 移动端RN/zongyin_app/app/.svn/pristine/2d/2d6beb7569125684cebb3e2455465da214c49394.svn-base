...
export default class TradingRecordCz extends Component {
    ...
    getDataList(isReload){
        let codeurl = host + '/AppAccount.dealRecord2.p.'+this.state.currentPage+'.do';
...
// }
        ...
        return <View>
            ...
            <View style={styles.bottomStyle}>
                ...
                <Text style={styles.nametext4}>{statestr}</Text>
            </View>
