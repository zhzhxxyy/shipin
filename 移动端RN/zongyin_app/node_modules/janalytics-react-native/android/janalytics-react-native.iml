...
<module external.linked.project.id=":janalytics-react-native" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":janalytics-react-native" />
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: __local_aars__:/Users/zxy/Desktop/zongyin_app/node_modules/janalytics-react-native/android/libs/janalytics-android-2.0.0.jar:unspecified@jar" level="project" />
